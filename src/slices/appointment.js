...
export const getEvents = () => async (dispatch) => {
  const response = await axios.get('/api/appointment/events');

  dispatch(slice.actions.getEvents(response.data));
};

export const createEvent = (data) => async (dispatch) => {
  const response = await axios.post('/api/appointment/events/new', data);
...
export const updateEvent = (eventId, update) => async (dispatch) => {
  const response = await axios.post('/api/appointment/events/update', {
    eventId,
    update
  });
...
export const deleteEvent = (eventId) => async (dispatch) => {
  await axios.post('/api/appointment/events/remove', {
    eventId
  });
